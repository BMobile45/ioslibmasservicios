...
class ViewController: UIViewController, CLLocationManagerDelegate {
    ...
    func doLogin(usr: String,psw: String){
        let params = "usr="+usr+"&psw="+psw+"&idf=0&cli=0&asis=1821&url=http://www.link2loyalty.com/AsistenciasL2L/api/ValidaMasServicios"
    ...
    func launchNotification(ttl: String,bdy: String,idx: Int){
        ...
        let request = UNNotificationRequest(identifier: "Bwigo", content: notificationContent, trigger: trigger)
    ...
    func locationManager(_ manager: CLLocationManager, didUpdateLocations locations: [CLLocation]) {
        ...
        if elapsed > 10{
            print("loc::: \(first.coordinate.longitude) | \(first.coordinate.latitude)")
            ...
            AF.request("https://bwigo.com/anago/class.api.php",method: .post,
